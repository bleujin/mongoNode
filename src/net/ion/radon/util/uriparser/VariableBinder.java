...
public class VariableBinder {
	 ...
	 * 
	 * <p>
	 * This method does not return <code>null</code>. If the specified variable name or type is not bound to any resolver the default resolver if returned instead.
	 * 
	 * @param name
	 *            The name of the variable.
	 * @param type
	 ...
	 * 
	 * <p>
	 * This method does not return <code>null</code>. If the specified variable name is no bound to any resolver the default resolver if returned instead.
	 * 
	 * @param name
	 ...
	 *            The variable name.
	 * 
	 * @return <code>true</code> if a given variable resolver is bound to the specific name; <code>false</code> otherwise (including if the name is <code>null</code>.
	 */
	 ...
	 *            The variable type.
	 * 
	 * @return <code>true</code> if a given variable resolver is bound to the specific type; <code>false</code> otherwise (including if the type is <code>null</code>.
	 */
