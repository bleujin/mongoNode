...
public class TokenOperatorD3 extends TokenBase implements TokenOperator {
	...
	public enum Operator {
		 ...
		 * 
		 * The prefix operator MUST only have one variable in its expansion. More than one variable is an error condition. If the variable is undefined or an empty list then substitute the empty string. If the variable is a defined non-list then substitute the value of arg preceeded by the value of the variable. If the variable is a defined list then substitute the concatenation of every list
		 * value preceeded by the arg.
		 * 
		 * Example:
		 * 
		 * <pre>
		 ...
		 */
		PREFIX {
			String expand(String arg, List<Variable> vars, Parameters parameters) throws UnsupportedEncodingException {
		 ...
		 * 
		 * The prefix operator MUST only have one variable in its expansion. More than one variable is an error condition. If the variable is undefined or an empty list then substitute the empty string. If the variable is a defined non-list then substitute the value of arg followed by the value of the variable. If the variable is a defined list then substitute the concatenation of every list value
		 * followed by the arg.
		 * 
		 * Example:
		 * 
		...
		/**
		 * Applies the expansion rules defined for the operator given the specified argument, variable and parameters.
		 * 
		 * @param arg
		 ...
		 */
		abstract String expand(String arg, List<Variable> vars, Parameters params) throws UnsupportedEncodingException;
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public String expand(Parameters parameters) throws UnsupportedEncodingException {
